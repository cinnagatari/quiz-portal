...
export default function QuestionSets() {
        ...
        if (currentQ !== -1)
            setCurrentQuestion(
                questions[
                    questions
                        .map(q => q.name)
                        .indexOf(currentSet.questions[currentQ])
                ]
            );
    }, [currentQ]);
    ...
    async function versionCheck() {
        ...
        await version
            .check(["s", "q"])
            .then(version => (versionState = version));
        ...
        if (versionState.s === "load")
            loadDB.sets().then(sets => setSets(sets));
        else {
    ...
    return (
        <div className="set-editor">
            ...
            <div className={"set-container bg-2-" + user.theme}>
                ...
                >
                    <div className={"center s-title bg-1-" + user.theme}>
                        Sets
                    </div>
                    <button
            ...
            <div>
                {currentSet !== "" && (
                    <div className={"set-container bg-2-" + user.theme}>
                        <div className={"s-title bg-1-" + user.theme}>
                            Questions
                        </div>
                        <div>
            ...
            {currentQuestion !== "" && (
                <Popup
                    ...
                    contents={
                        <div
                            className={
                                "center question-preview bg-2-" + user.theme
                            }
                        >
                            <button
                                className="btn-icon"
                            ...
                            <div
                                className={
                                    "center p-container bg-1-" + user.theme
                                }
                            >
                ...
                <div className={"fields-inputs"}>
                    ...
                    <button
                        ...
                        onClick={() => {
                            if (
                                ...
                                (!sets.map(s => s.name).includes(name) ||
                                    name === setEdit.name)
                            ) {
                                if (mode === "Add")
                                    addSet({
                                        name: name,
                                        questions: addedQuestions.map(
                                            q => q.name
                                        )
                                    });
                                else
                    ...
                    {addedQuestions.length !== 0 && (
                        <div className={"center stats-difficulty"}>
                            <p className={"stats-title bg-1-" + user.theme}>
                                Difficulty
                            </p>
            ...
            <div className="s-container">
                <div className={"left-container bg-1-" + user.theme}>
                    ...
                    <div className={"q-container bg-2-" + user.theme}>
                        <div>
                            <p className={"q-title bg-1-" + user.theme}>
                                Questions
                            </p>
                        </div>
                        <div>
                ...
                {currentQuestion !== "" && (
                    <div
                        className={"center right-container bg-1-" + user.theme}
                    >
